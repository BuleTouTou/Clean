...
def main():
    ...
    ws.append(["楼盘","行政区","板块","栋号","单元","室号","售价","业主电话","录入人工号","维护人工号","房源等级"])
    ws.append(["连心园","朝阳","常营","1号楼","1单元","101",500,"0013800000000","0260616013","260616013","S级"])
    ...
    assert ws.max_row==3 and ws["F2"].value==expected_community and ws["B2"].is_date
    assert ws["Y2"].value=="S级" and ws["Y3"].value in ("A类","B类","C类") and ws["AB2"].number_format=="@"
